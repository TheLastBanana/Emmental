...
protected:
	...
	void				smartAttackMove(BWAPI::Unit * attacker, BWAPI::Position targetPosition, bool force = false) const;
	void				smartMove(BWAPI::Unit * attacker, BWAPI::Position targetPosition, bool force = false) const;
