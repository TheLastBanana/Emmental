...
public:
	...
	const BuildOrderItem<PRIORITY_TYPE> & getHighestPriorityItem();	// returns the highest priority item
	const BuildOrderItem<PRIORITY_TYPE> & getNextHighestPriorityItem();	// returns the highest priority item
